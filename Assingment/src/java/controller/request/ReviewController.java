...
public class ReviewController extends BaseRequiredAuthorizationController {
    ...
    protected void processPost(HttpServletRequest req, HttpServletResponse resp, User user)
        ...
        // ✅ Nạp lại đơn sau khi update/xóa/duyệt để hiển thị dữ liệu mới nhất
        RequestForLeave updated = db.get(rid);

        // Nếu đơn bị xóa thì không thể load lại được, nên chỉ hiển thị thông báo
